...
[mango configuration(.config/mango/config.conf)](.config/mango/config.conf)  
[waybar config](.config/waybar/config.jsonc) and [waybar styling](.config/waybar/style.css) for dwm-like bar
